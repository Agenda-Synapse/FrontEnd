import { Estabelecimento, Loja, Proprietario } from 'src/app/models/shop';
...
export class ProprietarioService {
  ...
  postEstabelecimento(body: Estabelecimento): Observable<Estabelecimento>{
    const headerrs = new HttpHeaders({
      'ngrok-skip-browser-warning': 'true'
    })
    return this.http.post<Estabelecimento>(environment.API_URL + "/estabelecimentos", body, {headers: headerrs})
  }
}
